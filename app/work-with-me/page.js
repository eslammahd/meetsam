...
export const metadata = {
  ...
  description:
    "Most people diagnose. Few can fix. Fewer can build. I do all three.",
};
  ...
  return (
    <>
      ...
      <main>
        ...
        {/* Who I work with — moved off the homepage in Phase 0 */}
        <WhoIWorkWith />
        ...
        <section className="section">
          ...
          <ul className="proof">
            ...
            <li>
              ...
              45% with an LLM search assistant at an enterprise SaaS company
            </li>
            <li>
              Took trial-to-paid conversion from 30% to 50% in three months —
              a 67% lift, with no discount
            </li>
            <li>
              Cut churn from 30% to 22% in 90 days with a customer health
              scoring engine and request prioritization on top of it
            </li>
          </ul>
        </section>

        {/* The offers — moved off the homepage in Phase 0 */}
        <ServiceOptions />
